poem_list = [
    ...
    ("صَاحِ هَذِي قُبُورُنا تَمْلأ الرُّحْ", "بَ فأينَ القُبُورُ مِنْ عَهدِ عادِ"),
    ...
    ("إيه للّهِ دَرّكُنّ فأنْتُنّ اللْ", "لَوَاتي يُحْسِنّ حِفْظَ الوِدادِ"),
    ("ما نَسيتُنّ هالِكاً في الأوانِ ال", "خَالِي أوْدَى مِنْ قَبلِ هُلكِ إيادِ"),
    ...
    ("ثُمّ غَرِّدْنَ في المَآتِمِ وانْدُبْ", "نَ بِشَجْوٍ مَعَ الغَواني الخِرادِ"),
    ...
    ("فالعِراقيُّ بَعْدَهُ للحِجازِىْ", "يِ قليلُ الخِلافِ سَهْلُ القِيادِ"),
    ("وخَطيباً لو قامَ بَينَ وُحُوشٍ", "عَلّمَ الضّارِياتِ بِرَّ النِّقَادِ"),
    ("رَاوِياً للحَديثِ لم يُحْوِجِ المَعْ", "رُوفَ مِنْ صِدْقِهِ إلى الإِسْنادِ"),
    ...
    ("وَدِّعا أيّها الحَفيّانِ ذاكَ الشْ", "شَخْصَ إنّ الوَداعَ أيسَرُ زَادِ"),
    ...
    ("طالَما أخْرَجَ الحَزينُ جَوَى الحُزْ", "نِ إلى غَيْرِ لائِقٍ بالسَّدادِ"),
    ...
    ("خافَ غَدْرَ الأنامِ فاستَوْدَعَ الرّي", "حَ سَليلاً تَغْذُوهُ دَرَّ العِهَادِ"),
    ("وَتَوَخّى لَهُ النّجاةَ وَقَدْ أيْ", "قَنَ أنّ الحِمَامَ بالمِرْصادِ"),
    ("فَرَمَتْهُ بهِ على جانِبِ الكُرْ", "سِيّ أُمُّ اللُّهَيْمِ أُخْتُ النّآدِ"),
    ...
    ("وَانْتَهَى اليأسُ مِنكَ وَاستشعَرَ الوَاجِ", "دُ أنْ لا مَعادَ حتى المعادِ"),
    ...
    ("فَعَزيزٌ عَليّ خَلْطُ اللّيالي", "رِمَّ أقدامِكُمْ بِرِمّ الهَوَادي"),
    ("كُنتَ خِلّ الصِّبا فلَمّا أرادَ ال", "بَينَ وَافَقْتَ رأيَهُ في المُرادِ"),
    ...
    ("فليَكُنْ لِلْمُحَسَّنِ الأجَلُ المَمْ", "دودُ رَغْماً لآنُفِ الحُسّادِ"),
    ("وَلْيَطِبْ عَنْ أخيهِ نَفساً وأبْنا", "ء أخيهِ جَرائحِ الأكبادِ"),
    ("وإذا البَحْرُ غاضَ عنّي ولم أرْ", "وَ فلا رِيّ بادّخارِ الثِّمادِ"),
    ("كُلُّ بَيْتٍ للْهَدْمِ ما تَبْتَني الوَرْ", "قاءُ والسّيّدُ الرّفيعُ العِمادِ"),
    ("والفَتَى ظاعِنٌ ويَكفيهِ ظِلُّ السْ", "سَدْرِ ضَرْبَ الأطْنابِ والأوْتادِ"),
