poem_list = [
    ...
    ("إذا ما النّارُ لم تُطْعَمْ ضِراماً", "فأوْشِكْ أنْ تَمُرَّ بها رَمادا"),
    ("فظُنّ بسائِرِ الإخْوانِ شَرّاً", "ولا تأمَنْ على سِرٍّ فُؤادا"),
    ...
    ("وهَوَّنْتُ الخُطوبَ عليّ حتى", "كأني صِرتُ أمْنحُها الوِدادا"),
    ...
    ("يُؤجِّجُ في شُعاعِ الشمسِ ناراً", "ويَقْدَحُ في تَلَهّبِها زِنادا"),
    ...
    ("ولو مَلأ السُّهى عَيْنَيْهِ مِنّي", "أَبَرَّ على مَدَى زُحَلٍ وزادا"),
    ("أفُلّ نَوائبَ الأيامِ وحْدي", "إذا جَمَعَتْ كَتائِبَها احْتِشادا"),
    ("وقدْ أَثْبَتُّ رِجْلي في رِكابٍ", "جَعَلْتُ من الزَّماعِ له بَدَادا"),
    ("إذا أوْطَأتُها قَدَمَيْ سُهَيْلٍ", "فلا سُقِيَتْ خُناصِرَةُ العِهادا"),
    ("كأنّ ظِماءَهُنّ بناتُ نَعْشٍ", "يَرِدْنَ إذا وَرَدنا بِنا الثِّمادا"),
    ("ستَعْجَبُ من تَغَشْمُرِها لَيالٍ", "تُبارِيهَا كواكبُها سُهادا"),
    ...
    ("كأنّ الزِّبْرِقانَ بها أسيرٌ", "تُجُنِّبَ لا يُفَكُّ ولا يُفادى"),
    ...
    ("تذكَّرْتُ البِداوَةَ في أُناسٍ", "تَخالُ رَبيعَهُمْ سَنَةً جَمادا"),
    ("يَصيدونَ الفَوَارِسَ كلَّ يومٍ", "كما تَتَصَيّدُ الأُسْدُ النِّقادا"),
    ...
    ("بُناةُ الشِّعْرِ ما أكْفَوْا رَوِيّاً", "ولا عَرَفوا الإجازَةَ والسِّنادا"),
    ...
    ("فتىً يَهَبُ اللُّجَيْنَ المَحضَ جوداً", "ويَدَّخِرُ الحديدَ له عَتادا"),
    ("ويَلْبَسُ من جُلودِ عِداهُ سِبْتاً", "ويَرْفَعُ من رُؤوسِهِمُ النِّضَادا"),
    ("أبَنَّ الغَزْوَ مُكْتَهِلاً وبَدْرا", "وعُوّدَ أنْ يَسودَ ولا يُسادا"),
    ...
    ("يَذودُ سَخاؤُهَ الأذْوادَ عنه", "ويُحْسِنُ عن حرائِبِهِ الذِّيادا"),
    ("يَرُدّ بتُرْسِهِ النّكْباءَ عنّي", "ويجْعَلُ دِرْعَهُ تحْتي مِهادا"),
    ("فبِتُّ وإنّما ألْقَى خَيَالاً", "كمَنْ يَلْقَى الأسِنّةَ والصِّعادا"),
    ("وأطْلَسَ مُخْلِقِ السِّرْبالِ يَبْغي", "نَوافِلَنا صَلاحاً أو فَسادا"),
